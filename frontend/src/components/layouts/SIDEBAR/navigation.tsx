...
export function getNavigationItems(
    ...
    return [
        ...
        {
            id: 'staff-payouts',
            labelKey: 'nav.adminPayouts',
            fallbackLabel: 'Payouts drivers',
            icon: DollarSign,
            href: '/staff/payouts',
            section: 'governance',
            description: 'Pagos operativos a conductores.',
            allowedUserTypes: ['staff', 'admin'],
        },
        {
            id: 'staff-support',
            labelKey: 'nav.adminSupport',
            fallbackLabel: 'Soporte interno',
            icon: Headphones,
            href: '/staff/support',
            section: 'governance',
            description: 'Tickets, respuestas y escalamiento.',
            allowedUserTypes: ['staff', 'admin'],
        },
        ...(canAccessCeo
            ? [
