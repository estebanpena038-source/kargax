...
export function SlackSidebar({
    ...
    return (
        <div className="flex h-full flex-col bg-white dark:bg-zinc-950 select-none">
            {/* 1. ORGANIZATION HEADER (Steve Jobs / Apple Luxury Aesthetic) */}
            <div className="border-b border-zinc-200/80 p-3.5 bg-white dark:border-zinc-800 dark:bg-zinc-950">
                <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-zinc-950 text-white dark:bg-zinc-100 dark:text-zinc-950 shadow-sm flex-shrink-0 font-bold text-xs tracking-tight">
                            {orgInfo.companyName.slice(0, 2).toUpperCase()}
                        </div>
                        <div className="min-w-0">
                            <h2 className="text-xs font-bold text-zinc-950 dark:text-zinc-50 truncate tracking-tight">
                                {orgInfo.companyName}
                            </h2>
                    ...
                    <button
                        ...
                        className="rounded-lg p-1.5 text-zinc-500 hover:bg-zinc-100 hover:text-zinc-950 dark:text-zinc-400 dark:hover:bg-zinc-900 dark:hover:text-zinc-100 transition-colors"
                    >
                ...
                <div className="mt-3 flex items-center justify-between rounded-xl border border-zinc-200 bg-white p-2.5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div className="min-w-0">
                        <div className="text-[9px] font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">
                            Código de Invitación
                        </div>
                        <div className="text-xs font-mono font-bold tracking-wider text-zinc-950 dark:text-zinc-50">
                            {orgInfo.inviteCode}
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className={cn(
                            'flex items-center gap-1 rounded-lg px-2.5 py-1 text-[10px] font-semibold transition-all',
                            copiedCode
            ...
            {/* 2. SEARCH BAR */}
            <div className="p-3 border-b border-zinc-200/80 bg-white dark:border-zinc-800 dark:bg-zinc-950">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-xl border border-zinc-200 bg-white pl-8 pr-3 py-1.5 text-xs text-zinc-950 placeholder:text-zinc-400 transition-all dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50 focus:outline-none focus:border-zinc-950 focus:ring-1 focus:ring-zinc-950 dark:focus:ring-zinc-100"
                    />
                </div>
            </div>

            {/* 3. SECTIONS ACCORDION (Canales, Viajes Activos, Mensajes Directos, Archivados) */}
            <div className="flex-1 overflow-y-auto px-2 py-3 space-y-4 custom-scrollbar bg-white dark:bg-zinc-950">
                {isLoading ? (
                    <div className="space-y-2 p-2">
                        {[1, 2, 3, 4, 5].map((i) => (
                            <div key={i} className="h-8 rounded-lg bg-zinc-100 dark:bg-zinc-900 animate-pulse" />
                        ))}
                    </div>
                ) : (
                    <>
                        ...
                        <div>
                            <div
                                ...
                                className="group flex items-center justify-between px-2 py-1 text-[11px] font-bold uppercase tracking-wider text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 cursor-pointer"
                            >
                                ...
                                <button
                                    ...
                                    title="Nuevo canal"
                                    className="opacity-0 group-hover:opacity-100 p-0.5 rounded hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-opacity"
                                >
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    isActive
                                                        ? 'bg-zinc-950 text-white font-semibold shadow-sm dark:bg-zinc-100 dark:text-zinc-950'
                            ...
                            >
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <Truck className="h-3 w-3 text-zinc-950 dark:text-zinc-100" />
                                    ...
                                    {tripChannels.length === 0 ? (
                                        ...
                                        tripChannels.map((conv) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-center gap-2 min-w-0">
                                                        <Truck className="h-3.5 w-3.5 text-zinc-950 dark:text-zinc-100 flex-shrink-0" />
                                                        <span className="truncate font-medium">
                                                            {conv.title || conv.otherParticipantName}
                                                        </span>
                                                    </div>
                                                ...
                                                >
                                                    <div className="flex items-center gap-2 min-w-0">
                                                        <div className="relative flex-shrink-0">
                                                            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-zinc-950 text-white dark:bg-zinc-100 dark:text-zinc-950 text-[9px] font-bold uppercase">
            ...
            <div className="p-3 border-t border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-zinc-950">
                <button
                    onClick={onNewConversation}
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-zinc-950 px-3 py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-black dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-white transition-all active:scale-[0.98]"
                >
                    <Plus className="h-4 w-4" />
