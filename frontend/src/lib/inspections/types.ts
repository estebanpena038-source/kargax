/**
 * =============================================================================
 * KARGAX - INSPECTION REPORTS TYPES
 ...
 * empresas cuando los camioneros completan inspecciones de carga/entrega.
 * 
 * ARQUITECTURA:
 * - InspectionReport: Reporte consolidado con toda la evidencia
 * - InspectionSummary: Resumen ejecutivo de la inspección
 * - InspectionTimeline: Eventos en orden cronológico
 * - InspectionPhoto: Foto de evidencia con metadata GPS
 * 
 * ESCALABILIDAD:
...
// =============================================================================
// ENUMS & CONSTANTS
// Valores constantes que definen el estado y tipo de inspecciones
// =============================================================================
 ...
 */
export type InspectionPhase = 'loading' | 'delivery';
 ...
 */
export const EVENT_TYPE_LABELS: Record<string, Record<InspectionEventType, string>> = {
    'es-CO': {
...
export interface InspectionPhoto {
    ...
    itemStatus?: InspectionItemStatus;
 ...
 */
export interface InspectionManifestItem {
    /** ID único del item */
    id: string;
    /** Nombre del producto */
    name: string;
...
export interface InspectionReport {
    ...
    originLocation?: VerifiedLocation;
    /** Ubicación de destino verificada */
    destinationLocation?: VerifiedLocation;
 ...
 */
export interface GetInspectionReportResponse {
    success: boolean;
 ...
 */
export function getStatusColor(status: InspectionItemStatus | InspectionStatus): string {
 ...
 */
export function getStatusBadgeClasses(status: InspectionItemStatus | InspectionStatus): string {
 ...
 */
export function formatInspectionDate(isoString: string, locale: string = 'es-CO'): string {
    try {
 ...
 * @param report - Reporte de inspección
 * @returns True si tiene datos válidos
 */
export function isValidReport(report: InspectionReport | null | undefined): report is InspectionReport {
