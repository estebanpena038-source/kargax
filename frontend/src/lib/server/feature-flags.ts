...
const DEFAULT_FLAGS: Array<Omit<FeatureFlagSnapshot, 'source'>> = [
    ...
    { key: 'lending_enabled', enabled: false, scope: 'global', description: 'Habilita adelantos/credito KargaX. Pausado durante Acceso Operativo.', country_code: null, payload: { paused_reason: 'operational_access_focus' } },
    { key: 'pilot_generous_limits', enabled: true, scope: 'global', description: 'Limites altos para Acceso Operativo con expiracion controlada.', country_code: null, payload: { default_days: 14 } },
    { key: 'automatic_payouts_enabled', enabled: false, scope: 'global', description: 'Habilita retiros automaticos cuando los adaptadores esten listos.', country_code: null, payload: { providers: ['cobre'] } },
