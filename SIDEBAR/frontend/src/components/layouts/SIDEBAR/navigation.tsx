...
export const SIDEBAR_SECTION_META: Record<SidebarSectionKey, SidebarSectionMeta> = {
    command: {
        ...
        description: 'Lo que el usuario debe ver primero.',
        collapsedLabel: 'Mando',
    },
    operations: {
        title: 'Operación privada',
        description: 'Bodega, flota, equipo y control interno.',
        collapsedLabel: 'Operación',
    },
    marketplace: {
        title: 'Marketplace',
        description: 'Capacidad externa, ofertas y postulaciones.',
        collapsedLabel: 'MK',
    },
    money: {
        title: 'Dinero y límites',
        description: 'Planes, wallet y liquidación operativa.',
        collapsedLabel: '$',
    },
    governance: {
        title: 'Gobierno',
        description: 'Admin, corporativo y señales del sistema.',
        collapsedLabel: 'Gov',
    },
    support: {
        title: 'Cuenta',
        description: 'Preferencias y ayuda.',
    ...
    return [
        {
            ...
            href: '/dashboard',
            section: 'command',
            description: 'Resumen ejecutivo de la operación.',
            priority: 'primary',
        ...
        },
        {
            ...
            href: '/bodegas',
            section: 'operations',
            description: 'Inventario, picking, manifiesto y despacho.',
        ...
        },
        {
            ...
            section: 'operations',
            description: 'Conductores propios y compensación controlada.',
            allowedUserTypes: ['business', 'admin'],
        },
        {
        ...
        },
        {
            ...
            href: '/ofertas',
            section: 'marketplace',
            description: 'Ofertas externas separadas de la operación privada.',
            allowedUserTypes: ['trucker', 'business', 'admin'],
        },
        {
            id: 'offers-publish',
            ...
            section: 'marketplace',
            description: 'Abrir capacidad externa sin confundir bodega privada.',
            allowedUserTypes: ['business', 'admin'],
        },
        {
            id: 'my-offers',
            ...
            section: 'marketplace',
            description: 'Gestiona cargas abiertas y su trazabilidad.',
            allowedUserTypes: ['business', 'admin'],
        },
        {
            id: 'pod-marketplace',
        ...
        },
        {
            ...
            href: '/billetera',
            section: 'money',
            description: 'Liquidaciones y retiros del marketplace.',
            allowedUserTypes: ['trucker'],
        },
        {
            id: 'plans',
            labelKey: 'nav.plans',
            fallbackLabel: 'Planes y límites',
            icon: DollarSign,
            href: '/planes',
            section: 'money',
