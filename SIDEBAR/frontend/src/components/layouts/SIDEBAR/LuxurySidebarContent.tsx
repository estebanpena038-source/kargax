    ...
    const link = (
        <Link
            ...
            className={cn(
                ...
                'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950/18',
...
function NavigationSection({
    ...
    return (
        <section className="space-y-2" aria-label={meta.title}>
            {isCollapsed ? (
                <div className="flex justify-center py-1" title={meta.title}>
...
const WarehouseSelector = React.memo(function WarehouseSelector({
    ...
    return (
        <div className="px-4 py-3">
            <div className="rounded-3xl border border-zinc-200/80 bg-white/74 p-3 shadow-[0_20px_50px_-42px_rgba(0,0,0,.88)] backdrop-blur-xl">
                <Select
                    label="Bodega activa"
...
const UserProfileSection = React.memo(function UserProfileSection({
    ...
    return (
        <div className={cn('border-t border-zinc-200/70 p-3', isCollapsed ? 'px-2' : 'px-4')}>
            <div
                className={cn(
                    'rounded-3xl border border-zinc-200/80 bg-white/72 p-2 shadow-[0_22px_60px_-44px_rgba(0,0,0,.8)]',
...
function SidebarPresenceCard({ isCollapsed, planName }: { isCollapsed: boolean; planName?: string | null }) {
    ...
    return (
        <div className="px-4 py-4">
            <div className="overflow-hidden rounded-[1.75rem] border border-zinc-200/80 bg-white/72 p-4 shadow-[0_28px_80px_-52px_rgba(0,0,0,.9)] backdrop-blur-xl">
                ...
                <p className="mt-3 text-sm font-semibold leading-5 text-zinc-950">
                    Control logístico premium, sin ruido operativo.
                </p>
                <p className="mt-2 text-xs leading-5 text-zinc-500">
                    {planName || 'Operación, marketplace y evidencia separados.'}
                </p>
            </div>
        </div>
    );
